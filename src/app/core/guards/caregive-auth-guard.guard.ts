...
export const caregiveAuthGuardGuard: CanActivateFn = (route, state) => {
  ...
  if (token) {
    try {
      ...
      if (decodedToken.role.toLowerCase() !== 'caregiver') {
        console.log('User role is not caregiver, access denied');
